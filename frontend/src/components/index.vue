<template>
  ...
  <div class="index">
        ...
        <main>
            ...
            <div class="main-left">
              <el-menu default-active="/activePublic" class="el-menu-vertical-demo" :router="true">
                <el-menu-item index="/activePublic" :class="{'isActive': active}">Paper</el-menu-item>
                <el-menu-item index="/activeManage" :class="{'isActive': !active}">Tag Tree</el-menu-item>
              </el-menu>
            </div>
    ...
    <p>
      ...
      <router-link to="/showPdf">show pdf</router-link>
      <router-link to="/tag">tag tree</router-link>
    </p>
  </div>
</template>
