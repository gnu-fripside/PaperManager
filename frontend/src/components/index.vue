<template>
  <div class="index">
      ...
      <el-row>
        <el-col :span="24">
          <el-menu default-active="5" class="el-menu-demo" mode="horizontal" @select="">
            <el-menu-item index="1">Paper</el-menu-item>
            <el-menu-item index="2">Tag Tree</el-menu-item>
            <el-menu-item index="3">Import/Export</el-menu-item>
    ...
    <main>
      ...
      <div class="main-left">
        <el-menu default-active="/showPdf" class="el-menu-vertical-demo" :router="true">
          <el-menu-item index="/showPdf" :class="{'isActive': active}">Paper</el-menu-item>
          <el-menu-item index="/tagTree" :class="{'isActive': !active}">Tag Tree</el-menu-item>
          <el-menu-item index="/fileInfo" :class="{'isActive': !active}">File Info</el-menu-item>
        </el-menu>
      </div>
    ...
    <p>
      ...
      <router-link to="/showPdf">
        <el-button>show pdf</el-button>
      </router-link>
      <router-link to="/tag">
        <el-button>tag tree</el-button>
      </router-link>
    </p>
  </div>
</template>
